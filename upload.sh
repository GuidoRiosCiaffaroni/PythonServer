...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/PythonServer.git"
#git remote add origin https://github.com/GuidoRiosCiaffaroni/PythonServer.git
